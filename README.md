...
![Static Badge](https://img.shields.io/badge/Aktualisiert-14.04.2026-coral)
...
### 2.1 📕 Theorie
Die Folien mit der Theorie findet ihr auf Moodle oder unter diesem [Link](https://moodle.fhgr.ch/mod/resource/view.php?id=830708). <!-- // todo: replace link --> Für das Erarbeiten der Theorie im Unterricht sind im Ordner [theorie](theorie) pro Themenblock Code-Spaces vorbereitet.

### 2.2 🧠 Cheatsheets
Zu allen besprochenen Themen findest du im Ordner [cheatsheets](cheatsheets) sogenannte Cheatsheets. Es werden dort die Grundprinzipien erklärt und meist mit einfachen Beispielen veranschaulicht. Ausserdem findest du in den Cheatsheets Links mit weiteren Informationen zum Thema.
...
### 2.3 🧑🏽‍🏫 Code Alongs
Code-Alongs sind Übungen, welche wir im Unterricht gemeinsam lösen werden. Du findest im Ordner [code-Alongs](code-alongs) das benötigte Material. Ausserdem findest du im [README.md](code-alongs/README.md) in diesem Ordner eine Checkliste, wo du alle Code-Alongs, die du gemacht hast, als erledigt markieren kannst.

### 2.4 📝 Analoge Übungen
Im Unterricht werden wir ab und zu Übungen machen, die analog auf Papier gelöst werden. Das Material für diese Art Übungen findest du im Ordner [stift-und-papier](stift-und-papier).

### 2.5 💻 Digitale Übungen
Nebst den Code-Alongs haben wir auch Übungen vorbereitet, die du selbständig lösen kannst. Im Ordner [uebungen](uebungen) findest du das entsprechende Material. Die Übungen sind thematisch sortiert. Im [README.md](uebungen/README.md) in diesem Ordner sind ausserdem alle Übungen aufgelistet und nach Schwierigkeit vermerkt. Ausserdem kannst du alle Übungen, die du schon gemacht hast, als erledigt markieren.
