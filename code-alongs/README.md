...
| 02 | Steckbrief            | ⚙️     | DOM                                |
| 03 | Augenarzt             | ⚙️     | DOM, Events, JS & CSS              |
| 04 | Videoplayer           | ⚙️     | DOM, Events, Multimedia (Video)    |
| 05 | Worst DJ in the World | ⚙️     | DOM, Events, Multimedia (Audio)    |
| 06 | Dark Mode             | ⚙️     | LocalStorage, JS & CSS             |
| 07 | Motivator             | ⚙️     | Arrays, LocalStorage, DOM, Events  |
| 08 | Einkaufsliste         | ⚙️     | DOM, LocalStorage, Arrays          |
| 09 | Freundebuch           | ⚙️     | Objekte                            |
| 10 | Fun with Flags        | ⚙️     | JSON, Objekte, Spiel-Logik         |
| 11 | Projekt               | ⚙️     | API, Projekt-Planung               |
| 12 | Sonnenuhr             | ⚙️     | API                                |
| 13 | Wetterschmöcker       | ⚙️     | API                                |
